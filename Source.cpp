...
//void deposit(coating::particle* p_arg, Triangle* tri_arg, Point* P_arg, int MAXNUM_arg, double Tsub_arg, particleprop parprop_arg, Landing* l_arg) {
//
...
int main() {
	...
	find_avglength("Star.stl");
	/*AVG_L = 0.0159931;
	NUM_TRIANGLES = 198899;
	NUM_POINTS_RAW = 596697;*/

	mydata = from_stl("Star.stl");
	Triangle* t = mydata.t;
	Point* P = mydata.p;
